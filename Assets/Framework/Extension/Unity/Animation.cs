...
namespace AKBFramework
{
    public static class AnimationExtension
    {
        public static void PlaySequenced(this Animation animation, params string[] animations)
        {
            ...
            animation.gameObject.GetComponentInParent<MonoBehaviour>().StartCoroutine(AnimationSequence(animation, animations));
        }
        ...
        {
            //TODO should start the coroutine in a centralized place, will implement it later.
            animation.gameObject.GetComponentInParent<MonoBehaviour>().StartCoroutine(AnimationCallback(animation, name, callback));
        }
        
        public static void Play(this Animation animation, string name, Action<object> callback, object param)
        {
            //TODO should start the coroutine in a centralized place, will implement it later.
            animation.gameObject.GetComponentInParent<MonoBehaviour>().StartCoroutine(AnimationCallback(animation, name, callback, param));
        }
